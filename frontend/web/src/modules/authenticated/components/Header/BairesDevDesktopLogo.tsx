...
export const BairesDevDesktopLogo: React.FC = () => (
  <svg version="1.1" id="main-logo--desktop" xmlns="http://www.w3.org/2000/svg"
  xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 150 30"
  xmlSpace="preserve" width="149.8" height="28.5">
    <g>
      <path fill="#0272B1" d="M21.8,0.1H7c-3.8,0-6.9,3.2-6.9,7.1v14.3c0,3.9,3.1,7.1,6.9,7.1h14.8c3.8,0,6.9-3.2,6.9-7.1V7.3
      ...
      <path fill="#0272B1" d="M43.6,13.7c1.6-0.7,2.4-2,2.4-3.9c0-1.5-0.5-2.6-1.5-3.4S42,5.2,40.2,5.2h-6.7v18.4h7.1c2,0,3.6-0.5,4.7-1.4
      ...
      <path fill="#0272B1" d="M58.6,13.1c-0.4-0.7-1-1.2-1.7-1.5c-0.7-0.4-1.5-0.5-2.4-0.5c-1.1,0-2.1,0.3-3.1,0.9c-0.9,0.6-1.6,1.4-2.1,2.4
      ...
      <path fill="#0272B1" d="M65.6,5.1c-0.5,0-0.9,0.2-1.2,0.5c-0.3,0.3-0.5,0.7-0.5,1.2c0,0.5,0.2,0.9,0.5,1.2c0.3,0.3,0.7,0.5,1.2,0.5
      c0.5,0,0.9-0.2,1.2-0.5c0.3-0.3,0.5-0.7,0.5-1.2c0-0.5-0.2-0.9-0.5-1.2C66.5,5.3,66.1,5.1,65.6,5.1"/>
      <path fill="#0272B1" d="M76.2,11.2c-0.8,0-1.5,0.2-2.1,0.6c-0.6,0.4-1.1,0.9-1.4,1.7l0-2.1H70v12.2h2.8v-5.7c0-1.3,0.3-2.3,0.8-3
      c0.5-0.7,1.3-1.1,2.3-1.1c0.5,0,1,0.1,1.4,0.3l0.3-2.6c-0.2-0.1-0.4-0.1-0.7-0.2C76.6,11.2,76.4,11.2,76.2,11.2"/>
      <path fill="#0272B1" d="M87.3,11.7c-0.9-0.5-1.8-0.7-3-0.7c-1.2,0-2.3,0.3-3.2,0.9c-0.9,0.6-1.7,1.3-2.2,2.3c-0.5,1-0.8,2.1-0.8,3.3
      ...
      <path fill="#0272B1" d="M97.1,16.2c-0.6-0.2-1.1-0.3-1.5-0.5c-0.3-0.2-0.6-0.3-0.7-0.5c-0.1-0.2-0.2-0.4-0.2-0.7
      ...
      <path fill="#0272B1" d="M118.2,7.4c-1.8-1.6-4.4-2.5-7.6-2.5h-7.3v18.9h7c3.3,0,6-0.8,7.8-2.5c1.9-1.7,2.8-4,2.8-7
      C121,11.4,120.1,9.1,118.2,7.4 M116.6,14.4c0,4-2.1,5.9-6.3,5.9h-2.7V8.5h2.8C114.6,8.5,116.6,10.4,116.6,14.4"/>
      <path fill="#0272B1" d="M132.5,11.4c-0.9-0.5-2-0.8-3.2-0.8c-1.3,0-2.5,0.3-3.5,0.9c-1,0.6-1.8,1.4-2.3,2.5c-0.5,1-0.8,2.2-0.8,3.5
      ...
      <polygon fill="#0272B1" points="145.8,11 143,19.2 140.4,11 136.1,11 141,23.9 144.9,23.9 149.9,11"/>
    </g>
  </svg>
)
